...
const text = {
  ...
  workerHint       : "Use option ?c-w, --worker?R to see Worker support details.",
  sabHint          : "Use option ?c--sab?R to see SharedArrayBuffer as a parameter details.",
  ...
  criticalDataFile: `Critical error: data file not found.${lf}?yTry running with option --fupdate to download latest snapshot.`,
